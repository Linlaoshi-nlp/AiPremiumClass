...
import jieba 
from dmsc_comment_classifier import Comments_Classifier
...
# 加载词典
vocab = torch.load(r'dmsc_vocab.pth')
print(len(vocab))
...
model.load_state_dict(torch.load('dmsc_comments_classifier.pth', map_location=device))
model.to(device)
model.eval()
